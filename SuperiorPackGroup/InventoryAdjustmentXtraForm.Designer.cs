...
namespace SuperiorPackGroup
{
	...
	public partial class InventoryAdjustmentXtraForm : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			//
			this.adjustmentGridControl.Anchor = (System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right);
			this.adjustmentGridControl.DataSource = this.inventoryXPView;
			this.adjustmentGridControl.Location = new System.Drawing.Point(13, 291);
			this.adjustmentGridControl.MainView = this.adjustmentGridView;
			this.adjustmentGridControl.Name = "adjustmentGridControl";
			this.adjustmentGridControl.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {this.deleteRepositoryItemButtonEdit, this.reasonRepositoryItemMemoExEdit});
			this.adjustmentGridControl.Size = new System.Drawing.Size(768, 276);
			...
			//adjustmentGridView
			//
			this.adjustmentGridView.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {this.deleteGridColumn, this.idGridColumn, this.customerGridColumn, this.dateGridColumn, this.itemGridColumn, this.descriptionGridColumn, this.colLPN, this.locationCodeGridColumn, this.originalQuantityGridColumn, this.newQtyGridColumn, this.colOriginalLot, this.colNewLot, this.adjustmentGridColumn, this.reasonGridColumn, this.itemIDGridColumn, this.customerIDGridColumn, this.locationGridColumn});
			...
			this.filtersGroupControl.Location = new System.Drawing.Point(13, 198);
			this.filtersGroupControl.Name = "filtersGroupControl";
			this.filtersGroupControl.Size = new System.Drawing.Size(768, 87);
			...
			this.recordGroupControl.Size = new System.Drawing.Size(768, 181);
			...
			this.lpnLookUpEdit.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			...
			this.reasonMemoExEdit.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			...
			this.adjustmentDateEdit.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.adjustmentDateEdit.Properties.CalendarTimeProperties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton()});
			...
			this.originalLotLookUpEdit.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
...
//INSTANT C# NOTE: Converted design-time event handler wireups:
			...
			locationLookUpEdit.Validated += new System.EventHandler(locationLookupEdit_Validated);
			lpnLookUpEdit.Validated += new System.EventHandler(lpnLookUpEdit_Validated);
			originalLotLookUpEdit.Validated += new System.EventHandler(originalLotLookUpEdit_Validated);
			originalLotLookUpEdit.GetNotInListValue += new DevExpress.XtraEditors.Controls.GetNotInListValueEventHandler(originalLotLookUpEdit_GetNotInListValue);
			...
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(InventoryAdjustmentXtraForm_FormClosing);
			this.Load += new System.EventHandler(InventoryAdjustmentXtraForm_Load);
			deleteRepositoryItemButtonEdit.Click += new System.EventHandler(deleteRepositoryItemButtonEdit_Click);
			adjustmentGridView.CustomUnboundColumnData += new DevExpress.XtraGrid.Views.Base.CustomColumnDataEventHandler(adjustmentGridView_CustomUnboundColumnData);
			...
			AddLpnSimpleButton.Click += new System.EventHandler(AddLpnSimpleButton_Click);
		}
