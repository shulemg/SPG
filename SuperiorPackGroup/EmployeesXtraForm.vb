Public Class employeesXtraForm

    Private Sub EmployeesXtraForm_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub deleteSimpleButton_Click(sender As Object, e As EventArgs) Handles deleteSimpleButton.Click
        ...
        If employeeGridView.SelectedRowsCount > 0 Then
            If MessageBox.Show("Are you sure you want to delete this record/s?", "Delete Record", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                For i As Integer = 0 To employeeGridView.SelectedRowsCount - 1
                    Dim row As Integer = employeeGridView.GetSelectedRows()(i)
                    If row >= 0 Then
                        If EmployeesBLL.DeleteEmployee(CType(employeeGridView.GetRowCellValue(row, colOid), Integer)) <> True Then
