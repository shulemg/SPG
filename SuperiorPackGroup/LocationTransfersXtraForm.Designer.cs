...
namespace SuperiorPackGroup
{
	...
	public partial class LocationTransfersXtraForm : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			//BarManager1
			//
			this.BarManager1.Bars.AddRange(new DevExpress.XtraBars.Bar[] {this.transfersBar, this.Bar2, this.Bar3});
			this.BarManager1.DockControls.Add(this.barDockControlTop);
			this.BarManager1.DockControls.Add(this.barDockControlBottom);
			this.BarManager1.DockControls.Add(this.barDockControlLeft);
			this.BarManager1.DockControls.Add(this.barDockControlRight);
			this.BarManager1.Form = this;
			this.BarManager1.Items.AddRange(new DevExpress.XtraBars.BarItem[] {this.addBarButtonItem, this.editBarButtonItem, this.cancelBarButtonItem, this.saveBarButtonItem, this.deleteBarButtonItem, this.refreshBarButtonItem});
			...
			this.transferSearchGridControl.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {this.transferSearchGridView});
			//
			...
			//
			this.transferSearchGridView.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {this.colTransferID, this.colTransferNumber, this.colTransferDate});
			...
			this.dataEntrySplitContainerControl.Size = new System.Drawing.Size(542, 442);
			...
			this.transferDateDateEdit.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.transferDateDateEdit.Properties.CalendarTimeProperties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			...
			this.toLocationLookUpEdit.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			...
			this.fromLocationLookUpEdit.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			...
			//
			this.transferDetailsGridControl.Anchor = (System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right);
			...
			this.transferDetailsGridControl.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {this.itemRepositoryItemLookUpEdit, this.deleteRepositoryItemButtonEdit, this.LotRepositoryItemLookUpEdit});
			this.transferDetailsGridControl.Size = new System.Drawing.Size(542, 229);
			this.transferDetailsGridControl.TabIndex = 0;
			this.transferDetailsGridControl.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {this.transferDetailsGridView});
			//
			...
			//
			this.transferDetailsGridView.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {this.delGridColumn, this.colOid, this.GridColumn1, this.transferIDGridColumn, this.GridColumn3, this.transferItemGridColumn, this.fullLpnNumberGridColumn, this.colTransferLot, this.colItemExpirationDate, this.colTransferQuantity, this.colTransferUnits, this.colTransferPallets});
			...
			this.deleteRepositoryItemButtonEdit.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Delete, "", -1, false, true, false, EditorButtonImageOptions1, new DevExpress.Utils.KeyShortcut(System.Windows.Forms.Keys.None), SerializableAppearanceObject1, SerializableAppearanceObject2, SerializableAppearanceObject3, SerializableAppearanceObject4, "", null, null, DevExpress.Utils.ToolTipAnchor.Default)});
			...
			this.LotRepositoryItemLookUpEdit.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.LotRepositoryItemLookUpEdit.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[] {new DevExpress.XtraEditors.Controls.LookUpColumnInfo("Lot", "Lot", 38, DevExpress.Utils.FormatType.None, "", true, DevExpress.Utils.HorzAlignment.Near, DevExpress.Data.ColumnSortOrder.None, DevExpress.Utils.DefaultBoolean.Default)});
			...
			this.LotXpView.Properties.AddRange(new DevExpress.Xpo.ViewProperty[] {new DevExpress.Xpo.ViewProperty("Lot", DevExpress.Xpo.SortDirection.None, "[LocationInventoryLot]", true, true)});
			//
			...
			this.colItemExpirationDate.VisibleIndex = 4;
			...
			this.colTransferQuantity.VisibleIndex = 6;
			...
			this.colTransferUnits.VisibleIndex = 5;
			//
			//colTransferPallets
			//
			...
			this.colTransferPallets.VisibleIndex = 7;
...
//INSTANT C# NOTE: Converted design-time event handler wireups:
			...
			fromLocationLookUpEdit.Validated += new System.EventHandler(fromLocationLookUpEdit_Validated);
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(LocationTransfersXtraForm_FormClosing);
			this.Load += new System.EventHandler(LocationTransfersXtraForm_Load);
			saveBarButtonItem.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(saveBarButtonItem_ItemClick);
			transferDetailsGridView.CellValueChanged += new DevExpress.XtraGrid.Views.Base.CellValueChangedEventHandler(transferDetailsGridView_CellValueChanged);
			transferDetailsGridView.InitNewRow += new DevExpress.XtraGrid.Views.Grid.InitNewRowEventHandler(transferDetailsGridView_InitNewRow);
			transferDetailsGridView.InvalidRowException += new DevExpress.XtraGrid.Views.Base.InvalidRowExceptionEventHandler(transferDetailsGridView_InvalidRowException);
			transferDetailsGridView.ValidateRow += new DevExpress.XtraGrid.Views.Base.ValidateRowEventHandler(transferDetailsGridView_ValidateRow);
			transferSearchGridView.Click += new System.EventHandler(transferSearchGridView_Click);
			refreshBarButtonItem.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(refreshBarButtonItem_ItemClick);
			lpnNumberTextEdit.Validating += new System.ComponentModel.CancelEventHandler(lpnNumberTextEdit_Validating);
		}
