...
namespace SuperiorPackGroup
{
	...
	public partial class ProductionShiftXtraReport : DevExpress.XtraReports.UI.XtraReport
	{
		...
		private void InitializeComponent()
		{
			...
			this.shiftGroupHeader = new DevExpress.XtraReports.UI.GroupHeaderBand();
			this.shiftGroupFooter = new DevExpress.XtraReports.UI.GroupFooterBand();
			this.shiftTotalSalesXrLabel = new DevExpress.XtraReports.UI.XRLabel();
			this.shiftPriceXrLabel = new DevExpress.XtraReports.UI.XRLabel();
			this.shiftSalesVsPayrollXrLabel = new DevExpress.XtraReports.UI.XRLabel();
			this.shiftPricePerPieceXrLabel = new DevExpress.XtraReports.UI.XRLabel();
			this.shiftCostVariationPercentageXrLabel = new DevExpress.XtraReports.UI.XRLabel();
			this.shiftCostVariationXrLabel = new DevExpress.XtraReports.UI.XRLabel();
			this.shiftAverageCostXrLabel = new DevExpress.XtraReports.UI.XRLabel();
			this.shiftProjectedCostXrLabel = new DevExpress.XtraReports.UI.XRLabel();
			this.shiftPackersVariationPercentageXrLabel = new DevExpress.XtraReports.UI.XRLabel();
			this.shiftPackersVariationVolumeXrLabel = new DevExpress.XtraReports.UI.XRLabel();
			this.shiftAverageActualPackersXrLabel = new DevExpress.XtraReports.UI.XRLabel();
			this.shiftProjectedPackersXrLabel = new DevExpress.XtraReports.UI.XRLabel();
			this.shiftSpeedVariationPercentageXrLabel = new DevExpress.XtraReports.UI.XRLabel();
			this.shiftSpeedVariationVolumeXrLabel = new DevExpress.XtraReports.UI.XRLabel();
			this.shiftAverageSpeedXRLabel = new DevExpress.XtraReports.UI.XRLabel();
			this.shiftProjectedSpeedXrLabel = new DevExpress.XtraReports.UI.XRLabel();
			this.shiftQuantityXrLabel = new DevExpress.XtraReports.UI.XRLabel();
			this.shiftTotalMinutesXRLabel = new DevExpress.XtraReports.UI.XRLabel();
			...
			this.shiftHeaderXrLabel.LocationFloat = new DevExpress.Utils.PointFloat(0F, 0F);
			...
			this.shiftHeaderXrLabel.SizeF = new System.Drawing.SizeF(67F, 50F);
			...
			//shiftGroupHeader
			//
			this.shiftGroupHeader.GroupFields.AddRange(new DevExpress.XtraReports.UI.GroupField[] {new DevExpress.XtraReports.UI.GroupField("ShiftName", DevExpress.XtraReports.UI.XRColumnSortOrder.Ascending)});
			this.shiftGroupHeader.GroupUnion = DevExpress.XtraReports.UI.GroupUnion.WholePage;
			this.shiftGroupHeader.HeightF = 0F;
			this.shiftGroupHeader.KeepTogether = true;
			this.shiftGroupHeader.Name = "shiftGroupHeader";
			//
			//shiftGroupFooter
			//
			this.shiftGroupFooter.Controls.AddRange(new DevExpress.XtraReports.UI.XRControl[] {this.shiftTotalSalesXrLabel, this.shiftPriceXrLabel, this.shiftSalesVsPayrollXrLabel, this.shiftPricePerPieceXrLabel, this.shiftCostVariationPercentageXrLabel, this.shiftCostVariationXrLabel, this.shiftAverageCostXrLabel, this.shiftProjectedCostXrLabel, this.shiftPackersVariationPercentageXrLabel, this.shiftPackersVariationVolumeXrLabel, this.shiftAverageActualPackersXrLabel, this.shiftProjectedPackersXrLabel, this.shiftSpeedVariationPercentageXrLabel, this.shiftSpeedVariationVolumeXrLabel, this.shiftAverageSpeedXRLabel, this.shiftProjectedSpeedXrLabel, this.shiftQuantityXrLabel, this.shiftTotalMinutesXRLabel, this.XrLabel4});
			this.shiftGroupFooter.HeightF = 25F;
			this.shiftGroupFooter.KeepTogether = true;
			this.shiftGroupFooter.Name = "shiftGroupFooter";
			this.shiftGroupFooter.StyleName = "detailEvenXrControlStyle";
			this.shiftGroupFooter.StylePriority.UseTextAlignment = false;
			this.shiftGroupFooter.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
			//
			//shiftTotalSalesXrLabel
			//
			this.shiftTotalSalesXrLabel.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {new DevExpress.XtraReports.UI.XRBinding("Text", null, "totalSalesCalculatedField")});
			this.shiftTotalSalesXrLabel.LocationFloat = new DevExpress.Utils.PointFloat(995F, 0F);
			this.shiftTotalSalesXrLabel.Name = "shiftTotalSalesXrLabel";
			this.shiftTotalSalesXrLabel.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.shiftTotalSalesXrLabel.SizeF = new System.Drawing.SizeF(55F, 25F);
			this.shiftTotalSalesXrLabel.StylePriority.UseTextAlignment = false;
			XrSummary3.FormatString = "{0:$0.00}";
			XrSummary3.Running = DevExpress.XtraReports.UI.SummaryRunning.Group;
			this.shiftTotalSalesXrLabel.Summary = XrSummary3;
			this.shiftTotalSalesXrLabel.Text = "shiftTotalSalesXrLabel";
			this.shiftTotalSalesXrLabel.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleRight;
			//
			//shiftPriceXrLabel
			//
			this.shiftPriceXrLabel.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {new DevExpress.XtraReports.UI.XRBinding("Text", null, "Price", "{0:$0.00}")});
			this.shiftPriceXrLabel.LocationFloat = new DevExpress.Utils.PointFloat(940F, 0F);
			this.shiftPriceXrLabel.Name = "shiftPriceXrLabel";
			this.shiftPriceXrLabel.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.shiftPriceXrLabel.SizeF = new System.Drawing.SizeF(55F, 25F);
			this.shiftPriceXrLabel.StylePriority.UseTextAlignment = false;
			this.shiftPriceXrLabel.Text = "shiftPriceXrLabel";
			this.shiftPriceXrLabel.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleRight;
			//
			//shiftSalesVsPayrollXrLabel
			//
			this.shiftSalesVsPayrollXrLabel.LocationFloat = new DevExpress.Utils.PointFloat(885F, 0F);
			this.shiftSalesVsPayrollXrLabel.Name = "shiftSalesVsPayrollXrLabel";
			this.shiftSalesVsPayrollXrLabel.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.shiftSalesVsPayrollXrLabel.SizeF = new System.Drawing.SizeF(55F, 25F);
			this.shiftSalesVsPayrollXrLabel.StylePriority.UseTextAlignment = false;
			this.shiftSalesVsPayrollXrLabel.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleRight;
			//
			//shiftPricePerPieceXrLabel
			//
			this.shiftPricePerPieceXrLabel.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {new DevExpress.XtraReports.UI.XRBinding("Text", null, "pricePerPieceCalculatedField", "{0:$0.0000}")});
			this.shiftPricePerPieceXrLabel.LocationFloat = new DevExpress.Utils.PointFloat(830F, 0F);
			this.shiftPricePerPieceXrLabel.Name = "shiftPricePerPieceXrLabel";
			this.shiftPricePerPieceXrLabel.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.shiftPricePerPieceXrLabel.SizeF = new System.Drawing.SizeF(55F, 25F);
			this.shiftPricePerPieceXrLabel.StylePriority.UseTextAlignment = false;
			this.shiftPricePerPieceXrLabel.Text = "shiftPricePerPieceXrLabel";
			this.shiftPricePerPieceXrLabel.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleRight;
			//
			//shiftCostVariationPercentageXrLabel
			//
			this.shiftCostVariationPercentageXrLabel.LocationFloat = new DevExpress.Utils.PointFloat(775F, 0F);
			this.shiftCostVariationPercentageXrLabel.Name = "shiftCostVariationPercentageXrLabel";
			this.shiftCostVariationPercentageXrLabel.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.shiftCostVariationPercentageXrLabel.SizeF = new System.Drawing.SizeF(55F, 25F);
			//
			//shiftCostVariationXrLabel
			//
			this.shiftCostVariationXrLabel.LocationFloat = new DevExpress.Utils.PointFloat(720F, 0F);
			this.shiftCostVariationXrLabel.Name = "shiftCostVariationXrLabel";
			this.shiftCostVariationXrLabel.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.shiftCostVariationXrLabel.SizeF = new System.Drawing.SizeF(55F, 25F);
			this.shiftCostVariationXrLabel.StylePriority.UseTextAlignment = false;
			this.shiftCostVariationXrLabel.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleRight;
			//
			//shiftAverageCostXrLabel
			//
			this.shiftAverageCostXrLabel.LocationFloat = new DevExpress.Utils.PointFloat(665F, 0F);
			this.shiftAverageCostXrLabel.Name = "shiftAverageCostXrLabel";
			this.shiftAverageCostXrLabel.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.shiftAverageCostXrLabel.SizeF = new System.Drawing.SizeF(55F, 25F);
			this.shiftAverageCostXrLabel.StylePriority.UseTextAlignment = false;
			this.shiftAverageCostXrLabel.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleRight;
			//
			//shiftProjectedCostXrLabel
			//
			this.shiftProjectedCostXrLabel.LocationFloat = new DevExpress.Utils.PointFloat(610F, 0F);
			this.shiftProjectedCostXrLabel.Name = "shiftProjectedCostXrLabel";
			this.shiftProjectedCostXrLabel.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.shiftProjectedCostXrLabel.SizeF = new System.Drawing.SizeF(55F, 25F);
			this.shiftProjectedCostXrLabel.StylePriority.UseTextAlignment = false;
			this.shiftProjectedCostXrLabel.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleRight;
			//
			//shiftPackersVariationPercentageXrLabel
			//
			this.shiftPackersVariationPercentageXrLabel.LocationFloat = new DevExpress.Utils.PointFloat(555F, 0F);
			this.shiftPackersVariationPercentageXrLabel.Name = "shiftPackersVariationPercentageXrLabel";
			this.shiftPackersVariationPercentageXrLabel.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.shiftPackersVariationPercentageXrLabel.SizeF = new System.Drawing.SizeF(55F, 25F);
			//
			//shiftPackersVariationVolumeXrLabel
			//
			this.shiftPackersVariationVolumeXrLabel.LocationFloat = new DevExpress.Utils.PointFloat(500F, 0F);
			this.shiftPackersVariationVolumeXrLabel.Name = "shiftPackersVariationVolumeXrLabel";
			this.shiftPackersVariationVolumeXrLabel.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.shiftPackersVariationVolumeXrLabel.SizeF = new System.Drawing.SizeF(55F, 25F);
			//
			//shiftAverageActualPackersXrLabel
			//
			this.shiftAverageActualPackersXrLabel.LocationFloat = new DevExpress.Utils.PointFloat(445F, 0F);
			this.shiftAverageActualPackersXrLabel.Name = "shiftAverageActualPackersXrLabel";
			this.shiftAverageActualPackersXrLabel.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.shiftAverageActualPackersXrLabel.SizeF = new System.Drawing.SizeF(55F, 25F);
			//
			//shiftProjectedPackersXrLabel
			//
			this.shiftProjectedPackersXrLabel.LocationFloat = new DevExpress.Utils.PointFloat(390F, 0F);
			this.shiftProjectedPackersXrLabel.Name = "shiftProjectedPackersXrLabel";
			this.shiftProjectedPackersXrLabel.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.shiftProjectedPackersXrLabel.SizeF = new System.Drawing.SizeF(55F, 25F);
			this.shiftProjectedPackersXrLabel.Text = "shiftProjectedPackersXrLabel";
			//
			//shiftSpeedVariationPercentageXrLabel
			//
			this.shiftSpeedVariationPercentageXrLabel.LocationFloat = new DevExpress.Utils.PointFloat(335F, 0F);
			this.shiftSpeedVariationPercentageXrLabel.Name = "shiftSpeedVariationPercentageXrLabel";
			this.shiftSpeedVariationPercentageXrLabel.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.shiftSpeedVariationPercentageXrLabel.SizeF = new System.Drawing.SizeF(55F, 25F);
			//
			//shiftSpeedVariationVolumeXrLabel
			//
			this.shiftSpeedVariationVolumeXrLabel.LocationFloat = new DevExpress.Utils.PointFloat(280F, 0F);
			this.shiftSpeedVariationVolumeXrLabel.Name = "shiftSpeedVariationVolumeXrLabel";
			this.shiftSpeedVariationVolumeXrLabel.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.shiftSpeedVariationVolumeXrLabel.SizeF = new System.Drawing.SizeF(55F, 25F);
			//
			//shiftAverageSpeedXRLabel
			//
			this.shiftAverageSpeedXRLabel.LocationFloat = new DevExpress.Utils.PointFloat(225F, 0F);
			this.shiftAverageSpeedXRLabel.Name = "shiftAverageSpeedXRLabel";
			this.shiftAverageSpeedXRLabel.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.shiftAverageSpeedXRLabel.SizeF = new System.Drawing.SizeF(55F, 25F);
			//
			//shiftProjectedSpeedXrLabel
			//
			this.shiftProjectedSpeedXrLabel.LocationFloat = new DevExpress.Utils.PointFloat(170F, 0F);
			this.shiftProjectedSpeedXrLabel.Name = "shiftProjectedSpeedXrLabel";
			this.shiftProjectedSpeedXrLabel.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.shiftProjectedSpeedXrLabel.SizeF = new System.Drawing.SizeF(55F, 25F);
			this.shiftProjectedSpeedXrLabel.Text = "shiftProjectedSpeedXrLabel";
			//
			//shiftQuantityXrLabel
			//
			this.shiftQuantityXrLabel.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {new DevExpress.XtraReports.UI.XRBinding("Text", null, "Quantity")});
			this.shiftQuantityXrLabel.LocationFloat = new DevExpress.Utils.PointFloat(117F, 0F);
			this.shiftQuantityXrLabel.Name = "shiftQuantityXrLabel";
			this.shiftQuantityXrLabel.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.shiftQuantityXrLabel.SizeF = new System.Drawing.SizeF(53F, 25F);
			XrSummary4.FormatString = "{0:#,#}";
			XrSummary4.IgnoreNullValues = true;
			XrSummary4.Running = DevExpress.XtraReports.UI.SummaryRunning.Group;
			this.shiftQuantityXrLabel.Summary = XrSummary4;
			this.shiftQuantityXrLabel.Text = "shiftQuantityXrLabel";
			//
			//shiftTotalMinutesXRLabel
			//
			this.shiftTotalMinutesXRLabel.LocationFloat = new DevExpress.Utils.PointFloat(67F, 0F);
			this.shiftTotalMinutesXRLabel.Name = "shiftTotalMinutesXRLabel";
			this.shiftTotalMinutesXRLabel.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.shiftTotalMinutesXRLabel.SizeF = new System.Drawing.SizeF(50F, 25F);
			this.shiftTotalMinutesXRLabel.StylePriority.UseTextAlignment = false;
			this.shiftTotalMinutesXRLabel.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
			//
			//XrLabel4
			//
			this.XrLabel4.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {new DevExpress.XtraReports.UI.XRBinding("Text", null, "ShiftName")});
			...
			this.productionXPView.Properties.AddRange(new DevExpress.Xpo.ViewProperty[]
			{
				...
				new DevExpress.Xpo.ViewProperty("ShiftName", DevExpress.Xpo.SortDirection.Ascending, "[ProdMainShift.ShiftName]", false, true),
...
//INSTANT C# NOTE: Converted design-time event handler wireups:
		...
		shiftGroupHeader.BeforePrint += new System.Drawing.Printing.PrintEventHandler(ShiftGroupHeader_BeforePrint);
		...
		base.BeforePrint += new System.Drawing.Printing.PrintEventHandler(ProductionShiftXtraReport_BeforePrint);
		shiftTotalMinutesXRLabel.BeforePrint += new System.Drawing.Printing.PrintEventHandler(ShiftTotalMinutesXRLabel_BeforePrint);
		itemMinutesXrLabel.BeforePrint += new System.Drawing.Printing.PrintEventHandler(itemMinutesXrLabel_BeforePrint);
		shiftAverageSpeedXRLabel.BeforePrint += new System.Drawing.Printing.PrintEventHandler(ShiftAverageSpeedXRLabel_BeforePrint);
		itemAverageSpeedXrLabel.BeforePrint += new System.Drawing.Printing.PrintEventHandler(itemAverageSpeedXrLabel_BeforePrint);
		shiftSpeedVariationVolumeXrLabel.BeforePrint += new System.Drawing.Printing.PrintEventHandler(ShiftSpeedVariationVolumeXrLabel_BeforePrint);
		...
		shiftSpeedVariationPercentageXrLabel.BeforePrint += new System.Drawing.Printing.PrintEventHandler(ShiftSpeedVariationPercentageXrLabel_BeforePrint);
		...
		shiftAverageActualPackersXrLabel.BeforePrint += new System.Drawing.Printing.PrintEventHandler(ShiftAverageActualPackersXrLabel_BeforePrint);
		shiftPackersVariationVolumeXrLabel.BeforePrint += new System.Drawing.Printing.PrintEventHandler(ShiftPackersVariationVolumeXrLabel_BeforePrint);
		shiftPackersVariationPercentageXrLabel.BeforePrint += new System.Drawing.Printing.PrintEventHandler(ShiftPackersVariationPercentageXrLabel_BeforePrint);
		...
		shiftProjectedCostXrLabel.BeforePrint += new System.Drawing.Printing.PrintEventHandler(ShiftProjectedCostXrLabel_BeforePrint);
		shiftAverageCostXrLabel.BeforePrint += new System.Drawing.Printing.PrintEventHandler(ShiftAverageCostXrLabel_BeforePrint);
		shiftCostVariationXrLabel.BeforePrint += new System.Drawing.Printing.PrintEventHandler(ShiftCostVariationXrLabel_BeforePrint);
		shiftCostVariationPercentageXrLabel.BeforePrint += new System.Drawing.Printing.PrintEventHandler(ShiftCostVariationPercentageXrLabel_BeforePrint);
		...
		shiftSalesVsPayrollXrLabel.BeforePrint += new System.Drawing.Printing.PrintEventHandler(ShiftSalesVsPayrollXrLabel_BeforePrint);
		...
		shiftProjectedSpeedXrLabel.BeforePrint += new System.Drawing.Printing.PrintEventHandler(shiftProjectedSpeedXrLabel_BeforePrint);
		...
		shiftProjectedPackersXrLabel.BeforePrint += new System.Drawing.Printing.PrintEventHandler(shiftmachineProjectedPackersXrLabel_BeforePrint);
	}
		...
		internal DevExpress.XtraReports.UI.GroupHeaderBand shiftGroupHeader;
		internal DevExpress.XtraReports.UI.GroupFooterBand shiftGroupFooter;
		...
		internal DevExpress.XtraReports.UI.XRLabel shiftTotalMinutesXRLabel;
		...
		internal DevExpress.XtraReports.UI.XRLabel shiftQuantityXrLabel;
		internal DevExpress.XtraReports.UI.XRLabel shiftProjectedSpeedXrLabel;
		internal DevExpress.XtraReports.UI.XRLabel itemProjectedSpeedXrLabel;
		internal DevExpress.XtraReports.UI.XRLabel shiftAverageSpeedXRLabel;
		...
		internal DevExpress.XtraReports.UI.XRLabel shiftSpeedVariationVolumeXrLabel;
		internal DevExpress.XtraReports.UI.XRLabel itemSpeedVariationPercentageXrLabel;
		internal DevExpress.XtraReports.UI.XRLabel shiftSpeedVariationPercentageXrLabel;
		internal DevExpress.XtraReports.UI.XRLabel shiftPackersVariationPercentageXrLabel;
		internal DevExpress.XtraReports.UI.XRLabel shiftPackersVariationVolumeXrLabel;
		internal DevExpress.XtraReports.UI.XRLabel shiftAverageActualPackersXrLabel;
		internal DevExpress.XtraReports.UI.XRLabel shiftProjectedPackersXrLabel;
		...
		internal DevExpress.XtraReports.UI.XRLabel shiftCostVariationPercentageXrLabel;
		internal DevExpress.XtraReports.UI.XRLabel shiftCostVariationXrLabel;
		internal DevExpress.XtraReports.UI.XRLabel shiftAverageCostXrLabel;
		internal DevExpress.XtraReports.UI.XRLabel shiftProjectedCostXrLabel;
		...
		internal DevExpress.XtraReports.UI.XRLabel shiftPricePerPieceXrLabel;
		internal DevExpress.XtraReports.UI.XRLabel shiftSalesVsPayrollXrLabel;
		internal DevExpress.XtraReports.UI.XRLabel itemPriceXrLabel;
		internal DevExpress.XtraReports.UI.XRLabel shiftPriceXrLabel;
		internal DevExpress.XtraReports.UI.CalculatedField totalSalesCalculatedField;
		internal DevExpress.XtraReports.UI.XRLabel shiftTotalSalesXrLabel;
