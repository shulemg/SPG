...
Public Class ProductionShiftXtraReport

    Private m_IntervalHours As Double
    Private m_ShiftMinutes As Integer
    Private m_ShiftHours As Double
    ...
    Private Sub Detail_BeforePrint(ByVal sender As System.Object, ByVal e As Drawing.Printing.PrintEventArgs) Handles Detail.BeforePrint
        ...
        m_ShiftMinutes += CInt(m_IntervalHoursMinusBreak * m_MinPerHour)
    ...
    Private Sub ShiftSpeedVariationVolumeXrLabel_BeforePrint(ByVal sender As System.Object, ByVal e As Drawing.Printing.PrintEventArgs) Handles shiftSpeedVariationVolumeXrLabel.BeforePrint
        ...
        Else
            shiftSpeedVariationVolumeXrLabel.Text = Format(m_ShiftAverageSpeed - CDbl(GetCurrentColumnValue("ProjectedSpeed")), "#,##0.00")
        End If        
    ...
    Private Sub ShiftSpeedVariationPercentageXrLabel_BeforePrint(ByVal sender As System.Object, ByVal e As Drawing.Printing.PrintEventArgs) Handles shiftSpeedVariationPercentageXrLabel.BeforePrint
        ...
        Else
            speedVariation = (m_ShiftAverageSpeed - CDbl(GetCurrentColumnValue("ProjectedSpeed"))) / CDbl(GetCurrentColumnValue("ProjectedSpeed"))
        End If
            
        If Double.IsNaN(speedVariation) Or Double.IsInfinity(speedVariation) Then
            speedVariation = 0
        End If
        shiftSpeedVariationPercentageXrLabel.Text = Format(speedVariation, "%0.00")
    ...
    Private Sub ShiftAverageActualPackersXrLabel_BeforePrint(ByVal sender As System.Object, ByVal e As Drawing.Printing.PrintEventArgs) Handles shiftAverageActualPackersXrLabel.BeforePrint
        ...
        shiftAverageActualPackersXrLabel.Text = Format(m_ShiftAveragePackers, "#,##0.00")
    ...
    Private Sub ShiftPackersVariationVolumeXrLabel_BeforePrint(ByVal sender As System.Object, ByVal e As Drawing.Printing.PrintEventArgs) Handles shiftPackersVariationVolumeXrLabel.BeforePrint
        ...
        Else
            shiftPackersVariationVolumeXrLabel.Text = Format(m_ShiftAveragePackers - m_MachinePackers, "#,##0.00")
        End If
    ...
    Private Sub ShiftPackersVariationPercentageXrLabel_BeforePrint(ByVal sender As System.Object, ByVal e As Drawing.Printing.PrintEventArgs) Handles shiftPackersVariationPercentageXrLabel.BeforePrint
        ...
        If m_MachinePackers = 0 Then
            packersVariation = (m_ShiftAveragePackers - CDbl(GetCurrentColumnValue("ProjectedPackers"))) / CDbl(GetCurrentColumnValue("ProjectedPackers"))
        Else 
        ...
        If Double.IsNaN(packersVariation) Or Double.IsInfinity(packersVariation) Then
            packersVariation = 0
        End If
        shiftPackersVariationPercentageXrLabel.Text = Format(packersVariation, "%0.00")
    ...
    Private Sub ShiftProjectedCostXrLabel_BeforePrint(ByVal sender As System.Object, ByVal e As Drawing.Printing.PrintEventArgs) Handles shiftProjectedCostXrLabel.BeforePrint
        ...
        If m_MachineStandard > 0 Then
            If m_MachinePackers = 0 Then
                m_ShiftProjectedCost = 8 * m_PackersPay * CDbl(IIf(IsDBNull(GetCurrentColumnValue("ProjectedPackers")), 0, GetCurrentColumnValue("ProjectedPackers"))) / _
        ...
        Else
            ...
            Else 
                m_ShiftProjectedCost = 8 * m_PackersPay * m_MachinePackers / (CDbl(GetCurrentColumnValue("ProjectedSpeed")) * m_MinPerHour * 7)
            End If 
        End If
            
        If Double.IsNaN(m_ShiftProjectedCost) Or Double.IsInfinity(m_ShiftProjectedCost) Then
            m_ShiftProjectedCost = 0
        End If
        shiftProjectedCostXrLabel.Text = Format(m_ShiftProjectedCost * -1, "$#,##0.0000")
    ...
    Private Sub ShiftCostVariationPercentageXrLabel_BeforePrint(ByVal sender As System.Object, ByVal e As Drawing.Printing.PrintEventArgs) Handles shiftCostVariationPercentageXrLabel.BeforePrint
        ...
        If Double.IsNaN(costVariation) Or Double.IsInfinity(costVariation) Then
            costVariation = 0
        End If
        shiftCostVariationPercentageXrLabel.Text = Format(costVariation, "%0.00")
    ...
    Private Sub shiftProjectedSpeedXrLabel_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles shiftProjectedSpeedXrLabel.BeforePrint

        If m_MachineStandard > 0 Then
            shiftProjectedSpeedXrLabel.Text = Format(m_MachineStandard, "#,##0.00")
        Else
            shiftProjectedSpeedXrLabel.Text = Format(CDbl(GetCurrentColumnValue("ProjectedSpeed")), "#,##0.00")
        End If
    ...
    Private Sub shiftmachineProjectedPackersXrLabel_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles shiftProjectedPackersXrLabel.BeforePrint

        If m_MachinePackers > 0 Then
            shiftProjectedPackersXrLabel.Text = Format(m_MachinePackers, "#,##0.00")
        Else
            shiftProjectedPackersXrLabel.Text = Format(CDbl(GetCurrentColumnValue("ProjectedPackers")), "#,##0.00")
        End If
