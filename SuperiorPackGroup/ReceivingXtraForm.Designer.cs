...
namespace SuperiorPackGroup
{
	...
	public partial class ReceivingXtraForm : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.receivingsXtraTabControl.TabPages.AddRange(new DevExpress.XtraTab.XtraTabPage[] {this.generalXtraTabPage, this.detailsXtraTabPage, this.returnsXtraTabPage});
			//
			//generalXtraTabPage
			//
			...
			//
			this.SaveContinueSimpleButton.Location = new System.Drawing.Point(357, 420);
			...
			//BarManager1
			//
			this.BarManager1.Bars.AddRange(new DevExpress.XtraBars.Bar[] {this.receivingBar, this.Bar2, this.Bar3});
			this.BarManager1.DockControls.Add(this.barDockControlTop);
			this.BarManager1.DockControls.Add(this.barDockControlBottom);
			this.BarManager1.DockControls.Add(this.barDockControlLeft);
			this.BarManager1.DockControls.Add(this.barDockControlRight);
			this.BarManager1.Form = this;
			this.BarManager1.Items.AddRange(new DevExpress.XtraBars.BarItem[] {this.addBarButtonItem, this.editBarButtonItem, this.cancelBarButtonItem, this.saveBarButtonItem, this.receivingListBarButtonItem, this.refreshBarButtonItem, this.LpnLabelsBarButtonItem});
			...
			//
			this.correctPalletsComboBoxEdit.Location = new System.Drawing.Point(440, 376);
			...
			//LabelControl16
			//
			this.LabelControl16.Location = new System.Drawing.Point(360, 378);
			...
			//
			this.insectActivityComboBoxEdit.Location = new System.Drawing.Point(306, 375);
			...
			//LabelControl15
			//
			this.LabelControl15.Location = new System.Drawing.Point(188, 378);
			...
			//
			this.foreignSubstanceComboBoxEdit.Location = new System.Drawing.Point(134, 375);
			...
			//
			this.wheelsChockedComboBoxEdit.Location = new System.Drawing.Point(357, 350);
			...
			//LabelControl13
			//
			this.LabelControl13.Location = new System.Drawing.Point(268, 353);
			...
			//
			this.loadConditionLookUpEdit.Location = new System.Drawing.Point(357, 298);
			...
			//
			this.physicalConditionLookUpEdit.Location = new System.Drawing.Point(134, 298);
			...
			//LabelControl23
			//
			this.LabelControl23.Location = new System.Drawing.Point(268, 301);
			...
			//LabelControl22
			//
			this.LabelControl22.Location = new System.Drawing.Point(35, 301);
			...
			//LabelControl21
			//
			this.LabelControl21.Location = new System.Drawing.Point(35, 353);
			...
			//temperatureSpinEdit
			//
			this.temperatureSpinEdit.EditValue = new decimal(new int[] {0, 0, 0, 0});
			this.temperatureSpinEdit.Location = new System.Drawing.Point(134, 350);
			...
			this.temperatureSpinEdit.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.temperatureSpinEdit.Properties.Increment = new decimal(new int[] {5, 0, 0, 65536});
			...
			//LabelControl20
			//
			this.LabelControl20.Location = new System.Drawing.Point(268, 326);
			...
			this.finishTimeEdit.Location = new System.Drawing.Point(357, 323);
			this.finishTimeEdit.MenuManager = this.BarManager1;
			this.finishTimeEdit.Name = "finishTimeEdit";
			this.finishTimeEdit.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			...
			//LabelControl19
			//
			this.LabelControl19.Location = new System.Drawing.Point(35, 327);
			...
			this.startTimeEdit.Location = new System.Drawing.Point(134, 324);
			this.startTimeEdit.MenuManager = this.BarManager1;
			this.startTimeEdit.Name = "startTimeEdit";
			this.startTimeEdit.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			...
			//checkedByLookUpEdit
			//
			this.checkedByLookUpEdit.Location = new System.Drawing.Point(357, 272);
			...
			//LabelControl18
			//
			this.LabelControl18.Location = new System.Drawing.Point(268, 275);
			...
			//LabelControl17
			//
			this.LabelControl17.Location = new System.Drawing.Point(35, 275);
			...
			//
			this.unloadedByLookUpEdit.Location = new System.Drawing.Point(134, 272);
			...
			this.unloadedByLookUpEdit.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			...
			//LabelControl1
			//
			this.LabelControl1.Location = new System.Drawing.Point(35, 173);
			...
			//notesMemoEdit
			//
			this.notesMemoEdit.Location = new System.Drawing.Point(134, 170);
			...
			this.receiveDateEdit.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.receiveDateEdit.Properties.CalendarTimeProperties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton()});
			...
			//palletsTextEdit
			//
			this.palletsTextEdit.Location = new System.Drawing.Point(357, 144);
			this.palletsTextEdit.Name = "palletsTextEdit";
			this.palletsTextEdit.Properties.ReadOnly = true;
			this.palletsTextEdit.Size = new System.Drawing.Size(129, 20);
			this.palletsTextEdit.TabIndex = 21;
			this.palletsTextEdit.TabStop = false;
			//
			//skitsTextEdit
			//
			this.skitsTextEdit.Location = new System.Drawing.Point(134, 144);
			this.skitsTextEdit.Name = "skitsTextEdit";
			this.skitsTextEdit.Size = new System.Drawing.Size(126, 20);
			this.skitsTextEdit.TabIndex = 19;
			//
			//trailerTextEdit
			//
			...
			//LabelControl8
			//
			this.LabelControl8.Location = new System.Drawing.Point(35, 147);
			this.LabelControl8.Name = "LabelControl8";
			this.LabelControl8.Size = new System.Drawing.Size(85, 13);
			this.LabelControl8.TabIndex = 18;
			this.LabelControl8.Text = "Additional Pallets:";
			//
			//LabelControl7
			//
			...
			//LabelControl6
			//
			this.LabelControl6.Location = new System.Drawing.Point(274, 147);
			this.LabelControl6.Name = "LabelControl6";
			this.LabelControl6.Size = new System.Drawing.Size(62, 13);
			this.LabelControl6.TabIndex = 20;
			this.LabelControl6.Text = "Total Pallets:";
			//
			//LabelControl5
			//
			...
			//
			this.BulkEntryGroupControl.Anchor = (System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right);
			...
			this.ExpirationDateEdit.Properties.CalendarTimeProperties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.ExpirationDateEdit.Properties.MinValue = new DateTime(1800, 1, 1, 0, 0, 0, 0);
			...
			//
			this.receivingGridControl.Anchor = (System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right);
			...
			this.receivingGridControl.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {this.itemRepositoryItemLookUpEdit, this.delRepositoryItemButtonEdit, this.RepositoryItemDateEdit1, this.AddLotRepositoryItemButtonEdit, this.AddedLotCheckEdit});
			this.receivingGridControl.Size = new System.Drawing.Size(1124, 420);
			this.receivingGridControl.TabIndex = 0;
			this.receivingGridControl.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {this.receivingGridView});
			//
			//receivingGridView
			//
			this.receivingGridView.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {this.idGridColumn, this.receivingIDGridColumn, this.itemGridColumn, this.descriptionGridColumn, this.lotGridColumn, this.expirationDateGridColumn, this.quantityGridColumn, this.packagesGridColumn, this.ReceivDetLPNColumn, this.delGridColumn, this.AddedLotGridColumn});
			this.receivingGridView.GridControl = this.receivingGridControl;
			this.receivingGridView.GroupSummary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "ReceivDetQty", this.quantityGridColumn, "{0:#,##0.######}")});
			...
			this.RepositoryItemDateEdit1.MinValue = new DateTime(1800, 1, 1, 0, 0, 0, 0);
			...
			this.ReceivDetLPNColumn.Summary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {new DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Custom, "ReceivDetLPN", "")});
			...
			this.AddLotRepositoryItemButtonEdit.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Plus)});
			...
			//returnsGridView
			//
			this.returnsGridView.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {this.returnIDGridColumn, this.ReceiveMainIDGridColumn, this.returnItemGridColumn, this.returnItemDescGridColumn, this.returnLotGridColumn, this.returnExpirationDateGridColumn, this.returnQuantityGridColumn, this.returnUnitsGridColumn, this.returnPalletsGridColumn, this.returnReasonGridColumn, this.deleteGridColumn});
			...
			this.receivingSearchGridControl.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {this.customerFilterRepositoryItemLookUpEdit, this.receivingDateRepositoryItemDateEdit});
			this.receivingSearchGridControl.Size = new System.Drawing.Size(250, 488);
			this.receivingSearchGridControl.TabIndex = 0;
			this.receivingSearchGridControl.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {this.receivingSearchGridView});
			//
			...
			//
			this.receivingSearchGridView.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {this.BOLGridColumn, this.customerGridColumn, this.dateGridColumn, this.receivingIDSearchGridColumn});
			...
			this.receivingSearchGridView.SortInfo.AddRange(new DevExpress.XtraGrid.Columns.GridColumnSortInfo[] {new DevExpress.XtraGrid.Columns.GridColumnSortInfo(this.BOLGridColumn, DevExpress.Data.ColumnSortOrder.Ascending)});
			//
			//BOLGridColumn
			//
			...
			this.receivingDateRepositoryItemDateEdit.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.receivingDateRepositoryItemDateEdit.CalendarTimeProperties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton()});
			...
			this.customerFilterRepositoryItemLookUpEdit.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
...
//INSTANT C# NOTE: Converted design-time event handler wireups:
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(ReceivingXtraForm_FormClosing);
			this.Load += new System.EventHandler(ReceivingXtraForm_Load);
			receivingGridView.CustomUnboundColumnData += new DevExpress.XtraGrid.Views.Base.CustomColumnDataEventHandler(receivingGridView_CustomUnboundColumnData);
			...
			receivingGridView.InitNewRow += new DevExpress.XtraGrid.Views.Grid.InitNewRowEventHandler(receivingGridView_InitNewRow);
			...
			receivingSearchGridView.Click += new System.EventHandler(receivingSearchGridView_Click);
			...
			receivingGridView.CustomSummaryCalculate += new DevExpress.Data.CustomSummaryEventHandler(receivingGridView_CustomSummaryCalculate);
			...
			AddLotRepositoryItemButtonEdit.Click += new System.EventHandler(AddLotRepositoryItemButtonEdit_Click);
			...
			temperatureSpinEdit.Validating += new System.ComponentModel.CancelEventHandler(temperatureSpinEdit_Validating);
			receivingListBarButtonItem.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(receivingListBarButtonItem_ItemClick);
			itemRepositoryItemLookUpEdit.ProcessNewValue += new DevExpress.XtraEditors.Controls.ProcessNewValueEventHandler(itemRepositoryItemLookUpEdit_ProcessNewValue);
			refreshBarButtonItem.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(refreshBarButtonItem_ItemClick);
			LpnLabelsBarButtonItem.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(LpnLabelsBarButtonItem_ItemClick);
			AddToPalletButton.Click += new System.EventHandler(AddToPalletButton_Click);
			AddEntryButton.Click += new System.EventHandler(AddEntryButton_Click);
			ItemLookUpEdit.Validated += new System.EventHandler(ItemLookUpEdit_Validated);
			UnitsTextEdit.Validated += new System.EventHandler(UnitsTextEdit_Validated);
			LotTextEdit.Validated += new System.EventHandler(LotTextEdit_Validated);
			QtyTextEdit.Validated += new System.EventHandler(QtyTextEdit_Validated);
			UnitsPerPltTextEdit.Validated += new System.EventHandler(UnitsPerPltTextEdit_Validated);
			QtyPerPltTextEdit.Validated += new System.EventHandler(QtyPerPltTextEdit_Validated);
			SaveContinueSimpleButton.Click += new System.EventHandler(SaveContinueSimpleButton_Click);
			ItemLookUpEdit.Validating += new System.ComponentModel.CancelEventHandler(ItemLookUpEdit_Validating);
			ItemLookUpEdit.KeyDown += new System.Windows.Forms.KeyEventHandler(ItemLookUpEdit_KeyDown);
		}
