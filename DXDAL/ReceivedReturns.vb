...
Namespace SPGData
    <Persistent("tblReturnDet")> _
    Public Class ReceivedReturns
        ...
        Public Property ReturnDetID() As Integer
            ...
            End Set
        End Property
        Dim fReceiveMainID As Receiving
        <Association("Receiving-Returns")> _
        Public Property ReceiveMainID() As Receiving
            Get
                Return fReceiveMainID
            End Get
            Set(ByVal value As Receiving)
                SetPropertyValue(Of Receiving)("ReceiveMainID", fReceiveMainID, value)
            End Set
        End Property
...
Public Shadows Class FieldsClass
        ...
        Public ReadOnly Property ReturnDetID() As OperandProperty
            ...
            End Get
        End Property
        Public ReadOnly Property ReceiveMainID() As DXDAL.SPGData.Receiving.FieldsClass
            Get
                Return New DXDAL.SPGData.Receiving.FieldsClass(GetNestedName("ReceiveMainID"))
            End Get
        End Property
